...
\parindent 0mm
\parskip 2ex plus0.5ex minus0.3ex
...
This is only a placeholder. The real vignette has been
pre-created since it takes quite some time to process.
