...
protein.
%
<<chipAlongChromActc1, eval=FALSE, fig=FALSE, width=8, height=4, along=FALSE, results=hide>>=
...
%
<<smoothAlongChromActc1, eval=FALSE, fig=FALSE, width=8, height=4, along=FALSE, results=hide>>=
chipAlongChrom(X, chrom="2", xlim=c(113.8725e6,113.8835e6), ylim=c(-3,5),
               probeAnno=probeAnno, gff=mm9genes, paletteName='Set2')
...
@
%
<<histogramsSmoothed, eval=FALSE, fig=FALSE, width=7, height=7>>=
...
smoothed level.
%
<<plotCher1, eval=FALSE, fig=FALSE, width=8, height=4, along=FALSE, results=hide>>=
...
%
<<H3K4me3VsExpression, eval=FALSE, fig=FALSE, include=FALSE, width=9, height=7, boxplot=FALSE, results=hide>>=
